...
<template>
  <article class="post-card" :class="{ 'card--compact': props.size === 'compact' }">
    <div class="card-body">
    ...
    <a v-if="props.media" class="card-media" :href="props.href" :aria-label="`阅读全文：${props.title}`">
...
<style scoped>
/* 配色：使用 VitePress 主题变量，跟随主题色与深色模式 */
.post-card {
